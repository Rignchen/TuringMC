...
execute store result storage turing:data _private.foreach.i int 1 run scoreboard players get #i turing.data
function turing:turing/loop/foreach/call with storage turing:data _private.foreach
